...
def View_factors(Length_6h_0h,Length_9h_3h,Height_room,Breadth_wd,Length_wd):
    
    area_wd      = Length_wd*Breadth_wd
    area_wall_0h = Length_9h_3h * Height_room
    area_wall_3h = Length_6h_0h * Height_room
    area_wall_6h = Length_9h_3h * Height_room
    area_wall_9h = Length_6h_0h * Height_room
    area_ceiling = Length_6h_0h * Length_9h_3h - area_wd
    ...
    y_1_wd=max(0.001,(Length_6h_0h-Length_wd)/2)
    y_2_wd=y_1_wd+Length_wd
 
    FV_wd_to_ceiling=0
    FV_ceiling_to_wd=0

    FV_wd_to_floor=VF_para(Breadth_wd/2,Length_wd/2,Length_9h_3h/2,Length_6h_0h/2,0,0,Height_room)
    FV_floor_to_wd=VF_para(Length_9h_3h/2,Length_6h_0h/2,Breadth_wd/2,Length_wd/2,0,0,Height_room)
 
    FV_9h_to_wd_1=VF_perp   (0    ,Height_room,x_1_wd,Breadth_wd,Length_wd)
    FV_9h_to_wd_2=VF_perp_nt(0.001,Height_room,x_1_wd,Breadth_wd,Length_wd,0.0001,y_1_wd)
    FV_9h_to_wd  =(Length_wd*FV_9h_to_wd_1+2*y_1_wd*FV_9h_to_wd_2)/Length_6h_0h
    ...
    FV_0h_to_wd_1=VF_perp   (0    ,Height_room,y_1_wd,Length_wd,Breadth_wd)
    FV_0h_to_wd_2=VF_perp_nt(0.001,Height_room,y_1_wd,Length_wd,Breadth_wd,0.0001,x_1_wd)
    FV_0h_to_wd  =(Breadth_wd*FV_0h_to_wd_1+2*x_1_wd*FV_0h_to_wd_2)/Length_9h_3h
 
    FV_wd_to_0h=FV_0h_to_wd*area_wall_0h/area_wd
 
    FV_6h_to_wd=FV_0h_to_wd
    FV_wd_to_6h=FV_wd_to_0h
 
    # "!Compute view factors from wall 1 to wall 2"
    # "Two opposite identical planes"
    FV_0h_to_6h=VF_para_id(Length_9h_3h,Height_room,Length_6h_0h)
    FV_6h_to_0h=FV_0h_to_6h
    
    # "Wall to wall: corners"
    FV_0h_to_3h=VF_per(Length_9h_3h,Length_6h_0h,Height_room)
    FV_3h_to_0h=VF_per(Length_6h_0h,Length_9h_3h,Height_room)
    
    FV_0h_to_9h=FV_0h_to_3h
    FV_9h_to_0h=FV_3h_to_0h
    
    FV_0h_to_floor = VF_per(Height_room,Length_6h_0h,Length_9h_3h)
    FV_floor_to_0h = VF_per(Length_6h_0h,Height_room,Length_9h_3h)
...
# "!Compute the view factors of the ceiling "

    FV_3h_to_ceiling=1-(FV_3h_to_wd+FV_3h_to_0h+FV_3h_to_6h+FV_3h_to_9h+FV_3h_to_floor)
    FV_6h_to_ceiling=1-(FV_6h_to_wd+FV_6h_to_0h+FV_6h_to_3h+FV_6h_to_9h+FV_6h_to_floor)
    FV_9h_to_ceiling=1-(FV_9h_to_wd+FV_9h_to_0h+FV_9h_to_3h+FV_9h_to_6h+FV_9h_to_floor)
    FV_floor_to_ceiling=1-(FV_floor_to_wd+FV_floor_to_0h+FV_floor_to_3h+FV_floor_to_6h+FV_floor_to_9h)

    FV_ceiling_to_3h=FV_3h_to_ceiling*area_wall_3h/area_ceiling
    FV_ceiling_to_6h=FV_6h_to_ceiling*area_wall_6h/area_ceiling
    FV_ceiling_to_9h=FV_9h_to_ceiling*area_wall_9h/area_ceiling
    FV_ceiling_to_floor=FV_floor_to_ceiling*area_floor/area_ceiling
...
def CLF(iflag_internal_blind, iflag_suspended_ceiling, iflag_raised_floor, iflag_carpet, \
          M_A, azimuth_wd_deg, L_B, A1, D1_L, A2, D2_B, A3, D3_L, A4, D4_B, month, hour_start_plant, hour_stop_plant, method="LSODA"):
...
#     h_in=h_r + h_c
    ...
    # "! Windows areas supposed to be at the center of the ceiling"
    Breadth_wd_0 =0.6 # [m]
    L_B_wd=max(0.001,L_B)
 
    Length_wd_0 = L_B_wd*Breadth_wd_0
    if Length_wd_0 <= Length_6h_0h-0.2:
        Length_wd  = Length_wd_0
        Breadth_wd = Breadth_wd_0
    else:
        Length_wd  = Length_6h_0h-0.2
        Breadth_wd = (Length_6h_0h-0.2) / L_B_wd
    
    D_6h = D1_L * Length_wd
    D_9h = D2_B * Breadth_wd
    D_0h = D3_L * Length_wd
    D_3h = D4_B* Breadth_wd
    ...
    FV_wall,FV_to_wd,FV_wd_to = View_factors(Length_6h_0h,Length_9h_3h,Height_room,Breadth_wd,Length_wd)
    ...
    # gamma_w_deg comprised between -180° and 180°
    gamma_w_deg = azimuth_norm(azimuth_wd_deg)
    ...
    # gamma_0h_deg < gamma_3h_deg < gamma_6h_deg < gamma_9h_deg
    gamma_0h_deg = azimuth_wd_deg - 180
    gamma_3h_deg = azimuth_wd_deg - 90
    gamma_6h_deg = azimuth_wd_deg
    gamma_9h_deg = azimuth_wd_deg + 90
    
    # dgamma_deg comprised between -180° and 180°
    dgamma_0h_deg = np.where(abs(gamma_s_deg - gamma_0h_deg) > 180, abs(abs(gamma_s_deg - gamma_0h_deg) - 360),
                             abs(gamma_s_deg - gamma_0h_deg))
    dgamma_3h_deg = np.where(abs(gamma_s_deg - gamma_3h_deg) > 180, abs(abs(gamma_s_deg - gamma_3h_deg) - 360),
                             abs(gamma_s_deg - gamma_3h_deg))
    dgamma_6h_deg = np.where(abs(gamma_s_deg - gamma_6h_deg) > 180, abs(abs(gamma_s_deg - gamma_6h_deg) - 360),
                             abs(gamma_s_deg - gamma_6h_deg))
    dgamma_9h_deg = np.where(abs(gamma_s_deg - gamma_9h_deg) > 180, abs(abs(gamma_s_deg - gamma_9h_deg) - 360),
                             abs(gamma_s_deg - gamma_9h_deg))
...
#             cos_theta = cos_p * cos_theta_z[i] + sin_p * sin_theta_z[i] * cos_dgamma
            ...
            if (gamma_s_deg[i] >= gamma_3h_deg) & (gamma_s_deg[i] <= gamma_9h_deg) :
                A_L_deg = A_6h_deg ; D_L = D_6h
                cosdgamma_L = cos(dgamma_6h_deg[i] * pi / 180)
            else: 
                A_L_deg = A_0h_deg ; D_L = D_0h
                cosdgamma_L = cos(dgamma_0h_deg[i] * pi / 180)
                
            if (gamma_s_deg[i] >= gamma_0h_deg) & (gamma_s_deg[i] <= gamma_6h_deg) :
                A_B_deg = A_3h_deg ; D_B = D_3h
                cosdgamma_B = cos(dgamma_3h_deg[i] * pi / 180)
            else: 
                A_B_deg = A_9h_deg ; D_B = D_9h
                cosdgamma_B = cos(dgamma_9h_deg[i] * pi / 180)
                
            H_L = D_L * tan(A_L_deg * pi / 180)
            H_B = D_B * tan(A_B_deg * pi / 180)
            
            if tan(h_s_deg[i] * pi / 180) > 0.001 :
                D_SL = cosdgamma_L * H_L / tan(h_s_deg[i] * pi / 180)
                D_SB = cosdgamma_B * H_B / tan(h_s_deg[i] * pi / 180)
                L_wd_shade = min( Length_wd, max(0, D_SL-(D_L-Length_wd/2)))  if (D_L * A_L_deg > 0.0001) else 0
                B_wd_shade = min(Breadth_wd, max(0, D_SB-(D_B-Breadth_wd/2))) if (D_B * A_B_deg > 0.0001) else 0
            else:
                L_wd_shade = Length_wd  if (D_L * A_L_deg > 0.0001) else 0
                B_wd_shade = Breadth_wd if (D_B * A_B_deg > 0.0001) else 0

            dL_no_shade = Length_wd-L_wd_shade  if (Length_wd>L_wd_shade) else 0
            dB_no_shade = Breadth_wd-B_wd_shade if (Breadth_wd>B_wd_shade) else 0
            area_no_shaded_wd=dL_no_shade * dB_no_shade
